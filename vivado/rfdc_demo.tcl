...
################################################################
# This is a generated script based on design: rfdc_demo
#
...
xilinx.com:hls:snapshot_top:1.0\
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {218.855} \
   CONFIG.CLKOUT1_PHASE_ERROR {360.233} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {256.0} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {74.000} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {4.625} \
   CONFIG.MMCM_DIVCLK_DIVIDE {1} \
   CONFIG.PRIM_IN_FREQ {16.000} \
 ] $adc0_clk_wiz
  ...
  # Create instance: snapshot_top_0, and set properties
  set snapshot_top_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:snapshot_top:1.0 snapshot_top_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC0_Outclk_Freq {16.000} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins snapshot_top_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net snapshot_top_0_output_r [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins snapshot_top_0/output_r]
  connect_bd_intf_net -intf_net sysref_in_1 [get_bd_intf_ports sysref_in] [get_bd_intf_pins usp_rf_data_converter_0/sysref_in]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_pins snapshot_top_0/I] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m01_axis [get_bd_intf_pins snapshot_top_0/Q] [get_bd_intf_pins usp_rf_data_converter_0/m01_axis]
  ...
  connect_bd_net -net adc0_clk_wiz_clk_out1 [get_bd_pins adc0_clk_wiz/clk_out1] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_smc/aclk1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins snapshot_top_0/ap_clk] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins snapshot_top_0/ap_rst_n] [get_bd_pins usp_rf_data_converter_0/m0_axis_aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs snapshot_top_0/s_axi_CTRL/Reg] SEG_snapshot_top_0_Reg
